...
| `frontend/apps/platform-admin`   | Vite React app สำหรับ Platform Admin ของทีม TJ Solution         |
...
| ภาษา UI ของ frontend apps       | `03-frontend-routes.md`, `14-frontend-stack.md`, `TJ_POS_MASTER_GUIDE.md`                                                                                                                                                                  | `frontend/apps/web` เท่านั้นที่ใช้ i18n lo/en; app อื่นทั้งหมดให้เขียน static UI เป็นภาษาลาวตรงใน component/config/mock data ห้ามใช้ i18n/label map/helper สำหรับข้อความที่ render เป็น UI                                                                                  |
| ชื่อไฟล์ helper ภาษา            | `03-frontend-routes.md`, `14-frontend-stack.md`                                                                                                                                                                                            | ห้ามใช้ชื่อ `lao-labels.ts`, `mock-label-formatters.ts`, `legacy-ui-text.ts`, `i18n.ts`, `translations.ts` ใน app อื่น; technical id เป็น English ได้ แต่ต้องมี display label ภาษาลาวก่อน render                                                                               |
...
| Frontend app split              | `14-frontend-stack.md`, `16-frontend-vite-migration-plan.md`                                                                                                                                                                               | Next.js ใช้เฉพาะ `apps/web`; app admin และ app ฝั่งลูกค้าทั้งหมดใช้ Vite React                                                                                                                                                                                               |
...
| Wholesale support               | `02-web-menu-list.md`, `03-frontend-routes.md`, `05-menu-detail-spec.md`, `07-domain-schema.md`, `08-postgresql-database-schema.md`, `09-api-specification.md`, `11-remaining-implementation-spec.md`, `13-ui-design-image-groups.md`, `TJ_POS_MASTER_GUIDE.md` | ไม่สร้างกลุ่ม UI หรือ module แยกสำหรับ Wholesale; ให้รองรับขายส่งผ่าน Customers, Items, Orders, Payments, Reports และ Import/Export ที่มีอยู่แล้ว                                                                                                                         |
