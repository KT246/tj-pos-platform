...
Vite React ใช้กับ app ฝั่งลูกค้าทั้งหมด:
...
| `frontend/apps/platform-admin` | Next.js | Admin ของทีม TJ Solution |
...
```text
อัปเดต docs ให้ระบุว่า Next.js เหลือเฉพาะ web และ platform-admin
ระบุว่า app ฝั่งลูกค้าทั้งหมดเป็น Vite React
