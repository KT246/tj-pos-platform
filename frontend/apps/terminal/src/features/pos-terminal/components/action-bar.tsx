...
export function ActionBar({
  ...
  return (
    <div className="grid grid-cols-[1fr_1fr_1fr_0.7fr] gap-2 lg:gap-3">
      {actions.map((action) => {
        ...
        const className = `flex h-11 min-w-0 items-center justify-center gap-2 rounded-lg border px-2 text-[12px] font-black shadow-[0_8px_18px_rgba(15,23,42,0.03)] transition hover:-translate-y-0.5 ${toneClasses[action.tone]}`;
