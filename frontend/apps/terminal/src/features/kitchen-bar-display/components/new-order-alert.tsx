        ...
        <div className="p-8">
          <div className="rounded-2xl border border-blue-100 bg-blue-50/45 p-5">
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="text-[32px] font-black text-[#0b1736]">
                  {ticket.id}
                </div>
            ...
            <div className="mt-5 grid grid-cols-3 gap-3">
              <div className="rounded-xl bg-white px-4 py-3">
                <div className="flex items-center gap-2 text-[12px] font-black uppercase text-slate-500">
                  <ChefHat className="h-4 w-4" strokeWidth={2.2} />
                  Station
                </div>
                <div className="mt-1 text-[18px] font-black capitalize text-[#0b1736]">
                  {ticket.station}
                </div>
              </div>
              <div className="rounded-xl bg-white px-4 py-3">
