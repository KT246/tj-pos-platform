...
export function KitchenBoard({ mode, businessSlug, ticketRouteId }: KitchenBoardProps) {
  ...
  const setSoundEnabled = useKitchenDisplayStore((state) => state.setSoundEnabled);
  const setSettingsOpen = useKitchenDisplayStore((state) => state.setSettingsOpen);
  ...
  const startPreparing = useKitchenDisplayStore((state) => state.startPreparing);
  const markReady = useKitchenDisplayStore((state) => state.markReady);
  const completePickup = useKitchenDisplayStore((state) => state.completePickup);
