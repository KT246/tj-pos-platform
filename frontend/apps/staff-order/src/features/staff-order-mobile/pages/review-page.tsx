  ...
  return (
    ...
    >
      ...
      <StaffScrollArea className="pb-3">
        ...
        <section className="mt-3 grid grid-cols-[1fr_auto] items-center gap-3 rounded-lg border border-blue-100 bg-white p-3 shadow-[0_8px_22px_rgba(15,23,42,0.035)]">
    ...
    <div className="grid grid-cols-[64px_1fr_auto] gap-3 border-b border-blue-50 p-3 last:border-b-0">
      ...
      <div className="flex flex-col items-end justify-between">
        <div className="flex h-9 overflow-hidden rounded-lg border border-blue-100 bg-white">
          ...
          <span className="flex w-9 items-center justify-center border-x border-blue-100 text-[13px] font-black">
            {line.quantity}
          </span>
          <button
            type="button"
